...
const TimeInput = ({ ref, className, dateInputClassName, segmentClassName, disabled, 'data-invalid': dataInvalid, ...props }: TTimeInputProps & { ref?: React.RefObject<TTimeInputRef | null> }) => {
    return (
      <TimeField
        ref={ref}
